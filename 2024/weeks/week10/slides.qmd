...
A land surface *parameter* is an attribute of surface form (e.g. slope, aspect, wetness index); it is a raster. A land surface *object* is a discrete spatial feature (e.g. watershed line, cirque, alluvial fan, drainage network): it is a vector.
...
Let's practice. Create an R notebook using [this document](https://rpubs.com/ials2un/geomorphometric).